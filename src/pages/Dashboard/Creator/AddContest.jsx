...
const AddContest = () => {
  ...
  return (
    <div className="min-h-screen">
      <h3 className='text-center text-3xl font-bold text-base-content mb-5'>Create New Contest</h3>
      <div className="max-w-6xl mx-auto  shadow-xl overflow-hidden">

        <form onSubmit={handleSubmit(handleAddContest)} className="p-8 space-y-6">

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label className="block text-sm font-bold text-base-content/60 mb-2 uppercase tracking-wide">Contest Name</label>
              <input
          ...
          <div>
            <label className="block text-sm font-bold text-base-content/60 mb-2 uppercase tracking-wide">Banner Image</label>
            <input
          ...
          <div>
            <label className="block text-sm font-bold text-base-content/60 mb-2 uppercase tracking-wide">Description</label>
            <textarea
          ...
          <div>
            <label className="block text-sm font-bold text-base-content/60 mb-2 uppercase tracking-wide">Task Instructions</label>
            <textarea
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div>
              <label className="block text-sm font-bold text-base-content/60 mb-2 uppercase tracking-wide">Deadline</label>
              <Controller
                control={control}
                name="deadline"
                render={({ field }) => (
