          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <input
                ...
                className={`w-full p-3 rounded-xl border-2 transition-all outline-none ${errors.contest_name ? 'border-red-500 bg-red-50' : 'border-gray-100 focus:border-indigo-500'}`}
              />
